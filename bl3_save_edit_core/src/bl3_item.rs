...
pub enum ItemType {
    ...
    Artifact,
    #[strum(serialize = "BPInvPart_ClassMod_C", to_string = "职业模组")]
    ClassMod,
    #[strum(serialize = "BPInvPart_GrenadeMod_C", to_string = "手雷")]
    GrenadeMod,
...
pub enum ItemRarity {
    ...
    Common,
    #[strum(serialize = "02/Uncommon", to_string = "普通")]
    Uncommon,
    #[strum(
        serialize = "03/Rare",
    ...
    Legendary,
    #[strum(serialize = "Named Weapon", to_string = "独特的武器")]
    NamedWeapon,
    Unknown,
}
    ...
    fn inv_db_header_part_repeated(
        ...
        for _ in 0..num_parts {
            ...
            let ident = INVENTORY_SERIAL_DB
                .get_part_ident(category, part_idx)
                .unwrap_or_else(|_| "未知部件".to_owned());
