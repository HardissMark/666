...
impl Application for Bl3Application {
    ...
    fn title(&self) -> String {
        format!("无主之地 3 SE修改器（由哔哩哔哩up主HardissMark翻译） - v{}", VERSION)
    }
                                ...
                                match tab_bar_msg {
                                    SaveTabBarInteractionMessage::General => {
                                        self.view_state = ViewState::ManageSave(
                                            ManageSaveView::TabBar(SaveTabBarView::属性),
                                        )
                                    }
                                    ...
                                    SaveTabBarInteractionMessage::Currency => {
                                        self.view_state = ViewState::ManageSave(
                                            ManageSaveView::TabBar(SaveTabBarView::资产),
                                        )
                                    }
                                    SaveTabBarInteractionMessage::Vehicle => {
                                        self.view_state = ViewState::ManageSave(
                                            ManageSaveView::TabBar(SaveTabBarView::载具),
                                        )
                                    }
                                ...
                                match tab_bar_msg {
                                    ProfileTabBarInteractionMessage::General => {
                                        self.view_state = ViewState::ManageProfile(
                                            ManageProfileView::TabBar(ProfileTabBarView::属性),
                                        )
                                    }
                                    ProfileTabBarInteractionMessage::Profile => {
                                        self.view_state = ViewState::ManageProfile(
                                            ManageProfileView::TabBar(ProfileTabBarView::配置),
                                        )
                                    }
                                    ProfileTabBarInteractionMessage::Keys => {
                                        self.view_state = ViewState::ManageProfile(
                                            ManageProfileView::TabBar(ProfileTabBarView::钥匙),
                                        )
                                    }
                                    ProfileTabBarInteractionMessage::Bank => {
                                        self.view_state = ViewState::ManageProfile(
                                            ManageProfileView::TabBar(ProfileTabBarView::银行),
                                        )
                                    }
                                    ProfileTabBarInteractionMessage::Settings => {
                                        self.view_state = ViewState::ManageProfile(
                                            ManageProfileView::TabBar(ProfileTabBarView::设置),
                                        )
                                    }
                                }
                            }
    ...
    fn view(&mut self) -> Element<'_, Self::Message> {
        let title = Text::new("无主之地 3 SE修改器".to_uppercase())
        ...
        let mut save_button = Button::new(
            ...
            Text::new("保存").font(JETBRAINS_MONO_BOLD).size(17),
        )
        .padding(10)
        .style(Bl3UiStyle);
